  ...
  return (
    ...
    <div className={`pricing-card ${variant} ${highlight ? "highlight" : ""}`}>
      ...
      <div className="pricing-header">
        ...
        {tag && (
          <div className="pricing-tag">
            <Typography colorVariant="white" variant="body-5">{tag}</Typography>
          </div>
        )}
      </div>
      ...
      <div className="pricing-bottom">
        <button className="choose-btn"><Typography colorVariant="white" variant="h4">Choose Plan</Typography></button>
      </div>
    </div>
  );
}
