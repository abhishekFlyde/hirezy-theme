            ...
            <Container variant="topSpacing">
              <div>
                ...
                <div className="twoImageContainer">
                  <Image
                    src="https://ik.imagekit.io/a9uxeuyhx/ImageWithFallback%20(3).png"
                    width={432}
                    height={280}
                    className="twoImageContainer__image"
                  />
                  <Image
                    src="https://ik.imagekit.io/a9uxeuyhx/ImageWithFallback%20(4).png"
                    width={432}
                    height={280}
                    className="twoImageContainer__image"
                  />
      ...
      <div className="moreStoriesContainer">
        <Container variant="primary">
          ...
          <div className="moreStoriesCardContainer">
            <MoreStoriesCard
              image="https://ik.imagekit.io/a9uxeuyhx/ImageWithFallback%20(1).png"
            ...
            />
            <MoreStoriesCard
              image="https://ik.imagekit.io/a9uxeuyhx/ImageWithFallback%20(2).png"
              badge="75% faster hiring"
              category="FinTech Innovations"
              title="Scaling from 50 to 200 employees in 12 months"
              buttonText="Read Story"
